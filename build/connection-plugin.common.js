...
function defaultPath(points, _curvature) {
  ...
  var hx1 = Math.abs((x2 + x1) / 2);
  var hx2 = Math.abs((x2 + x1) / 2);
  return "M ".concat(x1, " ").concat(y1, " L ").concat(hx1, " ").concat(y1, " ").concat(hx2, " ").concat(y2, " ").concat(x2, " ").concat(y2);
}
...
function install(editor) {
  ...
  function pointerDown(e) {
    var _reteConnectionPlugin = this._reteConnectionPlugin,
        input = _reteConnectionPlugin.input,
        output = _reteConnectionPlugin.output;
